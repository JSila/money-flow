...
class RevenueSpec extends ObjectBehavior
{
    ...
    public function it_stores_inflows(Inflow $inflow)
    {
        $this->addInflow($inflow);
        $this->getInflows()->shouldHaveCount(1);

        $this->addInflow($inflow)
            ->addInflow($inflow);
        $this->getInflows()->shouldHaveCount(3);
    }
